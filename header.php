  ...
  <ul class="nav navbar-nav navbar-right">
    <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-user"></span> Login <span class = "caret"></span></a>
      <ul class="dropdown-menu">
        ...
        <li> <a href="profile_renter/loginRenter.php"><span class="glyphicon glyphicon-user"> </span> Login as Owner</a></li>
        <li> <a href="profile_buyer/loginBuyer.php"><span class="glyphicon glyphicon-user"> </span> Login as Renter</a></li>
      </ul>
    </li>
  </ul>
</div>
