...
input.oninvalid = function(event) {
    event.target.setCustomValidity('10 digit Number');
}
...
<body>
  ...
  <div class="panel-heading text-center" style="background-color: "><h2 style="background-color:;">One More step and you're good to go !! </h2></div>
  
  <br>
  <form id="form" class="form-horizontal panel-body" method="post" enctype="multipart/form-data" action="signUpRenterExe.php">
  ...
  <div class="form-group" id="fm">
   ...
   <div class="form-group" id="fm">
     ...
     <div class="col-sm-5">
     <input id="tel" type="number" class="form-control" id="address" placeholder="XX-XXXX-XXXX" name="cno" required pattern="[0-9]{1,10}">
   </div>
   </div>
   ...
   <div class="form-group" id="fm">
    ...
    <div class="text-center">
      <input type="submit" class="btn btn-success btn-sx" value="Submit" onclick="return validateForm()">
