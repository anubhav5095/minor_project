...
<div class="container-fluid">
  <ul class="nav navbar-nav" style="margin:0px;">
    ...
    <li class="headerLinks"><a href="#about"><i class="fa fa-fw fa-globe"> </i> About Us</a></li>
    <li class="headerLinks"><a href="#contact"><i class="fa fa-fw fa-envelope"></i> Contact Us</a></li>
  ...
  <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-user"></span> Login <span class="caret"></span></a>
      <ul class="dropdown-menu">
        <li><a href="admin\adminlogin.php"><span class="glyphicon glyphicon-user"> </span> Login Admin</a></li>
        <li><a href="profile_renter/loginRenter.php"><span class="glyphicon glyphicon-user"> </span> Login as Renter</a></li>
        <li><a href="profile_buyer/loginBuyer.php"><span class="glyphicon glyphicon-user"> </span> Login as Rentee</a></li>
      </ul>
    </li>
</div>
</nav>
